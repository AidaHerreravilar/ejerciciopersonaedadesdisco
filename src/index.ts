...
//No se han permitido la entrada a menores de 18 ni mayores de 40. Para la carga de los datos se usa la función aleatorio
...
function disco(minimo: number, mayor: number) {
  ...
  for (let index = 0; index < edades.length; index++) {
    ...
    if (edades[index] < 21) {
      ...
      console.log("las edades menores son:" + menores21);
      console.log(menores21.length);
    } else mayores21[index] = edades[index];
    console.log("las edades mayores en total son:" + mayores21);
    console.log("lacantidad de mayores de 21 son:" + mayores21.length);
  }
  return disco;
}
disco(19, 40);
